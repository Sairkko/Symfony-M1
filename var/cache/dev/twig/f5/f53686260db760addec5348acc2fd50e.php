...
class __TwigTemplate_b1de2db0dcacfb39c9eef35163972151 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Create new Activite</h1>

    ";
        // line 8
        echo twig_include($this->env, $context, "activite/_form.html.twig");
        echo "
...
{% block body %}
    <h1>Create new Activite</h1>

    {{ include('activite/_form.html.twig') }}

    <a href=\"{{ path('app_activite_index') }}\">back to list</a>
{% endblock %}
", "activite/new.html.twig", "/Users/bastien/IdeaProjects/Symfony-M1/templates/activite/new.html.twig");
    }
}
